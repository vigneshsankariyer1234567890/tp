    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Uuid("375004d8-5636-4084-977d-8d2b18a90e59"), new Name("Alex Yeoh"),
                ...
                new Address("Blk 30 Geylang Street 29, #06-40"), new CompletionStatusTag(), DEFAULT_REMARK,
                getTagSet("friends")),
            new Person(new Uuid("9cd01b04-7964-4d18-98a4-ab90c6520a19"), new Name("Bernice Yu"),
                new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new CompletionStatusTag(), DEFAULT_REMARK,
            ...
            new Person(new Uuid("89f38212-6066-466e-aa67-8391d4136a62"), new Name("David Li"),
                ...
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new CompletionStatusTag(), DEFAULT_REMARK,
                getTagSet("family")),
